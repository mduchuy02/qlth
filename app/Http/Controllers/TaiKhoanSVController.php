...
class TaiKhoanSVController extends Controller
{
    ...
    public function index()
    {
        ...
        $taikhoansvQuery = TaiKhoanSV::join('sinh_vien', 'tai_khoan_sv.ma_sv', '=', 'sinh_vien.ma_sv')
            ->select('tai_khoan_sv.ma_sv', 'sinh_vien.ten_sv', 'sinh_vien.email', 'sinh_vien.phai');
    ...
    public function update(Request $request, $id)
    {
        ...
        $taikhoan = TaiKhoanSV::findOrFail($id);
        ...
        public function store(Request $request)
        {
            ...
            $tai_khoan_sv = TaiKhoanSV::create([
                'ma_sv' => $request['ma_sv'],
